...
class PhonesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create phone" do
    assert_difference('Phone.count') do
      post phones_url, params: { phone: { numbers: @phone.numbers, user_id: @phone.user_id } }, as: :json
    end
  ...
  test "should update phone" do
    patch phone_url(@phone), params: { phone: { numbers: @phone.numbers, user_id: @phone.user_id } }, as: :json
    assert_response 200
  end
